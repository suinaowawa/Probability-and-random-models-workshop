...
for i = 1:m
    ...
    if X1(i)>0 && X2(i)>0 %for x in I quadrant
        ...
        Y11 = [Y11 y11];
        Y12 = [Y12 y12];
        if y11<-3||y12<-3 %for wrongly decoded case as the decision rule%change as new decision rule as computed in q9_calculate
            W11 = [W11 y11];
            W12 = [W12 y12];
        else    
    ...
    if X1(i)<0 && X2(i)>0 %for x in II quadrant
        ...
        Y21 = [Y21 y21];
        Y22 = [Y22 y22];
        if y21>-3||y22<-3 %for wrongly decoded case as the decision rule
            W21 = [W21 y21];
            W22 = [W22 y22];
        else    
            count = count+1; %count the correctly decoded points
    ...
    if X1(i)<0 && X2(i)<0 %for x in III quadrant
        ...
        Y31 = [Y31 y31];
        Y32 = [Y32 y32];
        if y31>-3||y32>-3 %for wrongly decoded case as the decision rule
            W31 = [W31 y31];
            W32 = [W32 y32];
        else    
            count = count+1; %count the correctly decoded points
    ...
    if X1(i)>0 && X2(i)<0 %for x in IV quadrant
        ...
        Y41 = [Y41 y41];
        Y42 = [Y42 y42];
        if y41<-3||y42>-3 %for wrongly decoded case as the decision rule
            W41 = [W41 y41];
            W42 = [W42 y42];
        else    
            count = count+1; %count the correctly decoded points
